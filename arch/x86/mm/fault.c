	...
	unsigned long error_code, unsigned long address)
{
	...
	VM_WARN_ONCE(
		...
		"ASI-sensitive data access from critical section, "
		"addr=%px error_code=%lx class=%s",
...
DEFINE_IDTENTRY_RAW_ERRORCODE(exc_page_fault)
{
	...
	/*
	 * TODO(b/270309388): Once we support changing ASI pagetable permissions
	 * all ASI faults should be for non-present pages, so we can skip this
	 * bit for protection faults etc.
	 */
